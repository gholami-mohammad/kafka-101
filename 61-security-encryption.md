...
ssl.keystore.location=/Users/sam/Desktop/workspace/kafka/secrets/kafka.server.keystore.jks
ssl.keystore.password=keystore-pass
ssl.key.password=keystore-pass
ssl.truststore.location=/Users/sam/Desktop/workspace/kafka/secrets/kafka.server.truststore.jks
...
```sh
mkdir secrets-client
cd secrets-client

cp /path/to/ca/ssl/ca-cert ./ca-cert
